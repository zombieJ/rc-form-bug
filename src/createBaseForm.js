...
import createFieldsStore from 'rc-form/es/createFieldsStore';
import {
  argumentContainer,
  identity,
  ...
  isEmptyObject,
  flattenArray
} from 'rc-form/es/utils';

var DEFAULT_TRIGGER = 'onChange';

var LifecycleDetector = createReactClass({
  componentDidMount: function () {
    var formCtx = this.props.formCtx;
      ...
      getFieldDecorator: function getFieldDecorator(name, fieldOption) {
        ...
        return function (fieldElem) {
          ...
          return React.createElement(LifecycleDetector, {
            name: name,
            formCtx: _this2,
          }, React.cloneElement(fieldElem, _extends({}, props, _this2.fieldsStore.getFieldValuePropValue(fieldMeta))));
        };
      },
